...
public class TicketIndian {
	...
	public TicketIndian(int ticketID, String noAdult, String noChildren, String adultUnitprice,
	...
	public String toString() {
		return "TicketIndian [id=" + id + ", TicketID=" + TicketID + ", NoAdult=" + NoAdult + ", NoChildren="
