...
<body>
	...
	<div class="page-content p-4" id="content">
		...
		%>
		<script>
			alert("New Animal Add Successfully..");
		...
		<div class="container card shadow m-5">
			<div class="card-body">
				<h5 class="p-2" style="border-bottom: 2px solid orange">Add New
					Animal</h5>
				<br>
				<div class="row">
					<div class="col-sm-12">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label>Animal Name</label> <input type="text"
											...
											placeholder="Enter Animal Name" required>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Animal Image</label> <input type="file" name="pic"
											accept=".jpg,.png" class="form-control" required>
									</div>
								</div>
							</div>
							<div class="form-row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Cage Number</label> <input type="text"
											...
											placeholder="Enter Cage Number" required>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Feed Number</label> <input type="text"
											name="FeedNumber" placeholder="Enter Feed Number"
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label>Breed</label> <input type="text" name="Breed"
											class="form-control" placeholder="Enter Breed" required>
									</div>
								</div>
							</div>
