...
<body>
	...
	<div class="page-content p-4" id="content">
		...
		<script>
			...
			window.location.assign("manageNativeTicket.jsp");
		</script>
		<%
			}
		%>
		...
		<div class="container card shadow m-5">
			<div class="card-body">
				...
				<div class="row">
					<div class="col-sm-12">
						<form method="post" action="AddNativeTicket">

							<div class="form-row">
								<div class="col-sm-12">
									<div class="form-group">
										<label>Adult</label> <input type="text" name="NoAdult"
											placeholder="Number of Adult" class="form-control" required>
									</div>
								</div>

								<div class="col-sm-12">
									<div class="form-group">
										<label>Children</label> <input type="text" name="NoChildren"
											placeholder="Number of Children" class="form-control"
											required>
									</div>
								</div>
								<hr>
