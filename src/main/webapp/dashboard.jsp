	...
	<div class="bg-white vertical-nav" id="sidebar">
		...
		<ul class="nav flex-column bg-white">
			...
			<li class="nav-item dropdown"><a href=""
				...
				<div class="dropdown-menu">
					<a href="nativeTicSearch.jsp" class="dropdown-item">Native
						Ticket Search</a> <a href="foreignTicSearch.jsp" class="dropdown-item">Foreigner
						Ticket Search</a>
				</div></li>
			...
			<div class="row">
				<%
					try {
						...
						ResultSet rs = st.executeQuery(
								"select sum(NoAdult) as totaladult from ticindian where date(PostingDate)=CURDATE()");
						if(rs.next()) {
							totaladult++;
						}
				%>
				<div class="col-sm-3 text-center mydiv">
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Today Native Adult Visitor</h4>
							<h2 class="text-primary">
								<%=rs.getString("totaladult")%>
							</h2>

						</div>

						<div class="card-footer">
							<a href="manageNativeTicket.jsp">View Details >>></a>
						</div>
					</div>
				</div>
				<%
				...
				<div class="col-sm-3 text-center mydiv">
					<%
						int totalchild = 0;
							ResultSet rs1 = st.executeQuery(
									"select sum(NoChildren) as totalchild from ticindian where date(PostingDate)=CURDATE()");
							if(rs1.next()) {
								totalchild++;
							}
					%>
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Today Native Children Visitor</h4>
							<h2 class="text-primary">
								<%=rs1.getString("totalchild")%>
							</h2>
						</div>
						<div class="card-footer">
							<a href="manageNativeTicket.jsp">View Details >>></a>
				...
				<div class="col-sm-3 text-center mydiv">
					<%
						int totaladulty = 0;
							ResultSet rs2 = st.executeQuery(
									"select sum(NoAdult) as totaladulty from ticindian where date(PostingDate)=CURDATE()-1");
							if(rs2.next()) {
								totaladulty++;
							}
					%>
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Yesterday Native Adult Visitor</h4>
							<h2 class="text-primary">
								<%=rs2.getString("totaladulty")%>
							</h2>
						</div>
						<div class="card-footer">
							<a href="manageNativeTicket.jsp">View Details >>></a>
				...
				<div class="col-sm-3 text-center mydiv">
					<%
						int totalchildy = 0;
							ResultSet rs3 = st.executeQuery(
									"select sum(NoChildren) as totalchildy from ticindian where date(PostingDate)=CURDATE()-1");
							if(rs3.next()) {
								totalchildy++;
							}
					%>
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Yesterday Native Child Visitor</h4>
							<h2 class="text-primary">
								<%=rs3.getString("totalchildy")%>
							</h2>
						</div>
						<div class="card-footer">
							<a href="manageNativeTicket.jsp">View Details >>></a>
             ...
             <div class="row mt-5">
				<div class="col-sm-3 text-center mydiv">					
					<%
						int totaladultt = 0;
							ResultSet rs4 = st.executeQuery(
									"select sum(NoAdult) as totaladultt from ticforeigner where date(PostingDate)=CURDATE()");
							if(rs4.next()) {
								totaladultt++;
							}
					%>
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Today Foreign Adult Visitor</h4>
							<h2 class="text-primary">
								<%=rs4.getString("totaladultt")%>
							</h2>
						</div>
						<div class="card-footer">
							<a href="manageForeignTicket.jsp">View Details >>></a>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-3 text-center mydiv">					
					<%
						int totalchildd = 0;
							ResultSet rs5 = st.executeQuery(
									"select sum(NoChildren) as totalchildd from ticforeigner where date(PostingDate)=CURDATE()");
							if(rs5.next()) {
								totalchildd++;
							}
					%>
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Today Foreign Child Visitor</h4>
							<h2 class="text-primary">
								<%=rs5.getString("totalchildd")%>
							</h2>
						</div>
						<div class="card-footer">
							<a href="manageForeignTicket.jsp">View Details >>></a>
				...
				<div class="col-sm-3 text-center mydiv">					
					<%
						int totaladultyy = 0;
							ResultSet rs6 = st.executeQuery(
									"select sum(NoAdult) as totaladultyy from ticforeigner where date(PostingDate)=CURDATE()-1");
							if(rs6.next()) {
								totaladultyy++;
							}
					%>
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Yesterday Foreign Adult Visitor</h4>
							<h2 class="text-primary">
								<%=rs6.getString("totaladultyy")%>
							</h2>
						</div>
						<div class="card-footer">
							<a href="manageForeignTicket.jsp">View Details >>></a>
				...
				<div class="col-sm-3 text-center mydiv">					
					<%
						int totalchildyy = 0;
							ResultSet rs7 = st.executeQuery(
									"select sum(NoChildren) as totalchildyy from ticforeigner where date(PostingDate)=CURDATE()-1");
							if(rs7.next()) {
								totalchildyy++;
							}
					%>
					<div class="container1">
						<div class="card-body">
							<h4 class="text-success">Yesterday Foreign Child Visitor</h4>
							<h2 class="text-primary">
								<%=rs7.getString("totalchildyy")%>
							</h2>
						</div>
						<div class="card-footer">
							<a href="manageForeignTicket.jsp">View Details >>></a>
