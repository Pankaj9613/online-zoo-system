...
<body>
	...
	<div class="bg-white vertical-nav" id="sidebar">
		...
		<ul class="nav flex-column bg-white">
			...
			<li class="nav-item dropdown"><a href=""
				class="nav-link dropdown-toggle text-dark bg-light" id="navbardrop"
				data-toggle="dropdown"> <i
					class="fas fa-cloud-moon-rain fa-fw mr-3 text-primary"></i> Contact
					Us Query
			</a>

				<div class="dropdown-menu">
					<a href="unreadQuries.jsp" class="dropdown-item">Unread Queries</a>
					<a href="readQuries.jsp" class="dropdown-item">Read Queries</a>
				</div></li>
	...
	<div class="page-content p-4" id="content">
		...
		<div class="container card shadow m-5">
			<div class="card-body">
				<h5 class="p-2" style="border-bottom: 2px solid orange">Edit Animal</h5>
				<br>
				<%                    
					int id = Integer.parseInt(request.getParameter("id"));
                    AnimalDAO dao= new AnimalDAO(DBConnect.getConn());
					Animal a =dao.getAnimalById(id);					
				%>
				<div class="row">
					<div class="col-sm-12">
						<form method="post" enctype="multipart/form-data" action="UpdateAnimal">
							<input type="hidden" name="id" value="<%= id%>">
							<div class="form-row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Animal Name</label> <input type="text"
											name="AnimalName" class="form-control"
											value="<%= a.getAnimalName()%>">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
									<img src="images2/<%= a.getPhoto()%>" width="100" height="100" class="float-right">
										<label>Animal Image</label> <input type="file" name="pic"
							...
							<div class="form-row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Cage Number</label> <input type="text"
											name="CageNumber" class="form-control"
											value="<%= a.getCageNumber()%>">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Feed Number</label> <input type="text"
											name="FeedNumber" value="<%= a.getFeedNumber()%>"
											class="form-control">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label>Breed</label> <input type="text" name="Breed"
											class="form-control" value="<%= a.getBreed()%>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<textarea rows="4" class="form-control" style="resize: none"
									name="Description"><%= a.getDescription()%></textarea>
							</div>
