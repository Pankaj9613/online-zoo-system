...
<body>
	...
	<div class="page-content p-4" id="content">
		...
		<script>
			...
			window.location.assign("manageTicketType.jsp");
		</script>
		<%
			}
		%>
		<div class="container card shadow m-5">
			<div class="card-body">
				<h5 class="p-2" style="border-bottom: 2px solid orange">Edit
					Ticket Type</h5>
				<br>
				<%
					int tid = Integer.parseInt(request.getParameter("tid"));
					TicketDAO dao = new TicketDAO(DBConnect.getConn());
					Ticket t = dao.getTicketById(tid);
				%>
				<div class="row">
					<div class="col-sm-12">
							...
							<div class="form-row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label>Ticket Type</label> <input type="text"
											name="TicketType" value="<%= t.getTicketType()%>" class="form-control">
									</div>
								</div>

								<div class="col-sm-12">
									<div class="form-group">
										<label>Ticket Price</label> <input type="text" name="Price"
											value="<%=t.getPrice()%>" class="form-control">
									</div>
								</div>
								<hr>
								<input type="submit" value="Update Ticket Type"
