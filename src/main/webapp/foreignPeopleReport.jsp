			...
			<div class="card-body">
				...
				<div class="container-fluid mt-2">
					...
					<div class="form-group">
						<form method="post" action="ForeignReportDtls.jsp">
							<label><b>From Date</b></label> <input type="date"
								name="fromdate" class="form-control" required> <label><b>To
									Date</b></label> <input type="date" name="todate" class="form-control"
