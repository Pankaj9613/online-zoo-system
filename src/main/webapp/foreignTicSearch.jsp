...
<!-- End Data Table -->
		...
		<div class="container card shadow m-5">
			<div class="card-body">
				<h5 class="p-2" style="border-bottom: 2px solid orange">Foreigner
					Ticket Search</h5>
				<br>

				<div class="container-fluid mt-2">
					<div class="form-group">
						<form method="post" action="foreignTicSearch.jsp">
							<label><b>Search by Ticket ID</b></label> <input type=text
								name="search" class="form-control"
								placeholder="Search by Ticket ID" required> <br> <input
								type=submit name=submit value="Search" class="btn btn-primary">
						</form>
					</div>
				</div>
									...
									<tbody>
										<%
											...
											try {
												...
												ResultSet rs = st.executeQuery("select * from ticforeigner where TicketID = " + search + "");
												while (rs.next()) {
													i = i + 1;
										%>
										...
										<tr>
											...
											<td><a
												href="viewForeignTicket.jsp?id=<%=rs.getInt("id")%>"
