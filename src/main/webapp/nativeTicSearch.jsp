...
<body>
	...
	<div class="page-content p-4" id="content">
		...
		<div class="container card shadow m-5">
			<div class="card-body">
				<h5 class="p-2" style="border-bottom: 2px solid orange">Native
					Ticket Search</h5>
				<br>

				<div class="container-fluid mt-2">
					<div class="form-group">
						<form method="post" action="nativeTicSearch.jsp">
									...
									<tbody>
										<%
											...
											try {
												...
												ResultSet rs = st.executeQuery("select * from ticindian where TicketID = "+ search +"");
												while (rs.next()) {
													i = i + 1;
										%>
										...
										<tr>
											...
											<td><a
												href="viewNativeTicket.jsp?id=<%=rs.getInt("id")%>"
