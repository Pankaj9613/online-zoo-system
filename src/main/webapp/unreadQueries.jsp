...
<!-- End Data Table -->
	...
	<div class="card shadow mt-5">
      <div class="card-body">
       <h5 class="p-2" style="border-bottom: 2px solid orange;">Unread Queries </h5>
       <div class="container-fluid mt-5">
            <table id="example" class="table table-striped table-bordered">
                 ...
                 <tbody>
                      <%					 
					   try
					   {
						...
						ResultSet rs = st.executeQuery("select * from contacts where isRead is null");
						int i =0;
						while(rs.next())
						{
							i++;
                ...
                <tr>
                    ...
                    <td><a href="viewQueries.jsp?id=<%=rs.getInt("id") %>" class="text-primary">View Details</a></td>
                </tr>
                   <% 		
						}
					  }
