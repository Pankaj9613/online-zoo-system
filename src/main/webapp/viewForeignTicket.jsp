...
<%@page import="com.zoo.NativeTicDAO"%>
<%@page import="com.zoo.TicketIndian"%>
...
<body>
	...
	<div class="page-content p-4" id="content">
		...
		try {
			...
			ResultSet rs = st.executeQuery("select * from ticforeigner where id=" + id + "");
			int i = 0;
			int totaladultcost = 0;
			int totalchildcost = 0;
			int totalcost = 0;
			while (rs.next()) {
				i++;

				totaladultcost = Integer.parseInt(rs.getString("NoAdult"))
						* Integer.parseInt(rs.getString("AdultUnitprice"));
				totalchildcost = Integer.parseInt(rs.getString("NoChildren"))
						* Integer.parseInt(rs.getString("ChildUnitprice"));
				totalcost = totaladultcost + totalchildcost;
	   %>

		<div class="container card shadow m-5">
			<div class="card-body">
				<h5 class="p-2" style="border-bottom: 2px solid orange">View
					Foreigner Ticket Details</h5>
				<br>
					...
					<div class="card">
						<div class="card-body" id="exampl">
							<h5 class="float-right">
								<span style="color: green;">Visiting Date :-</span>
								<%=rs.getString("PostingDate")%>
							</h5>
							<h5>
								<span style="color: green;">Generated Ticket ID :-</span>
								<%=rs.getString("TicketID")%>
							</h5>
							<p style="color: blue"></p>

							<table border="1"
								class="table table-striped table-bordered first mt-5">
								<tr>
									<th>Ticket Type</th>
									<th>No of Tickets</th>
								...
								<tr>
									...
									<td style="padding-left: 10px"><%=rs.getString("NoAdult")%></td>
									<td style="padding-left: 10px"><%=rs.getString("AdultUnitprice") %></td>
									<td style="padding-left: 10px"><%=totaladultcost%></td>
								</tr>
								<tr>
									<th>Number of Chlidren</th>
									<td style="padding-left: 10px"><%=rs.getString("NoChildren")%></td>
									<td style="padding-left: 10px"><%=rs.getString("ChildUnitprice")%></td>
									<td style="padding-left: 10px"><%=totalchildcost%></td>
								</tr>

								<tr>
									<th style="text-align: center; color: red; font-size: 20px"
										colspan="3">Total Price</th>
									<td style="padding-left: 10px;"><%=totalcost%></td>
								</tr>
							</table>
