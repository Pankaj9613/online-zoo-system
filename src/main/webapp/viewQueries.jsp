...
<body>
    ...
    <div class="card-body">
        <h5 class="p-2" style="border-bottom: 2px solid orange;">View Queries Details</h5>
        <div class="container-fluid mt-5">
            ...
            <table class="table table-bordered">
                <tr align="center">
                    <td colspan="4" style="font-size : 20px; color : red"> View Queries Details</td>
                </tr>
                ...
                <tr>
                    ...
                    <th>Enquiry Date</th>
                    <td><%=rs.getString("msgDate")%></td>
                </tr>

                <tr>
                    <th>Enquiry Message</th>
                    <td colspan="3"><%=rs.getString("message")%></td>
                </tr>
            </table>
            <%
						}
                   ...
                   try{
                	   ...
                	   st1.executeUpdate("update contacts set isRead='yes' where id="+id+"");                  
